...
public class WorldRenderer extends Controller {
    ...
    public static final float WORLD_WIDTH = 8f; // columns
    public static final float WORLD_HEIGHT = 13.5f; // rows
    ...
    public void setSize(float width, float height) {
        ...
        pixelsPerUnitX = camera.viewportWidth / WORLD_WIDTH;
        pixelsPerUnitY = camera.viewportHeight / WORLD_HEIGHT;
    }
